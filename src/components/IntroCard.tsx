  ...
  return (
    <div className="mx-auto w-full max-w-screen-xl px-2.5 md:px-20 p-6 flex justify-between gap-20">
      ...
      <div className="w-full h-[450px] bg-yellow-600/50 rounded-3xl flex flex-col items-center justify-center gap-6">
        ...
        <p className="text-zinc-700 max-w-3xl text-2xl md:text-3xl lg:text-4xl font-featureDeck font-bold text-center">let no communication gap can interrupt your and your  team's workflow together work to detail on every aspect.</p>
      </div>
    </div>
  )
}
